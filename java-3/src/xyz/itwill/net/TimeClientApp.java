...
//NTP Server에 접속하여 서버에서 보내온 날짜와 시간을 얻어와 출력하는 클ㄹ라이언트 프로그램
public class TimeClientApp {
	public static void main(String[] args) throws ClassNotFoundException {
		try {
			...
			System.out.println("[결과]서버에서 제공한 날짜와 시간 = "+new SimpleDateFormat("yyyy년 MM월 dd일 E요일 HH시 mm분 dd일").format(date));
