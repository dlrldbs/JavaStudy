...
<%-- 문제점)웹자원이 저장된 ContextRoot 디렉토리의 경로가 변경될 경우 해당 자원을 찾을 수 없어 404 에러 발생 가능 --%>
<%-- 해결법)메소드를 호출하여 ContextRoot 디렉토리의 경로를 반환받아 절대경로로 표현하는 것을  --%>
<%-- <img src="/JSP/action/template_site/images/Koala.jpg" width="300"> --%>

<%-- request.getContextPath() : 요청 JSP 문서가 위치한 ContextRoot 디렉토리의 경로르 반환하는 --%>
