...
//학생정보(학번,이름,국어,영어,총점)를 저장하기 위한 클레스 - VO클래스
public class Student {
	...
	//정적 필드(Static Field) : 클래스 생성시 메모리(Static)에 만들어지는 필드
	...
	//생성자(Constructor)
	// => 객체 생성시 인스턴스 필드에 원하는 초기값을 저장하기 위한 기능 제공 
	public Student() {
	...
	*/
	...
	// => 정적 필드만 접근하여 사용 가능
	// => 객체 생성 전에 클래스을 이름을 사용하여 호출 가능 - 메소드 호출의 용이성
