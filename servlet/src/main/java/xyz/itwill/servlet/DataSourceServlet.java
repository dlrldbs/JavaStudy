...
//Apache Tomcat 라이브러리에서 제공하는 DBCP 기능을 사용하여  Connection 객체를 미리 생성하고
//생성된 Connection 객체를 제공받아 클라이언트에게 전달하는 서블릿
...
public class DataSourceServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//BasicDataSource 객체에 저장될 Connection 객체 생성 관련 정보를 메소드를 호출하여 
		//객체 필드값 변경
