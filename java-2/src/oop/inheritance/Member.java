...
// => 공통적인 속성과 행위를 가진 다수 클래스 작성시 공통적인 속성과 행위가 선언된 클래스를
//상속받아 작성 : 유지보수의 효율성 증가
...
//      }
// => 부모클래스의 생성자를 자식클래스에게 상속되지 않으며 부모클래스의 은닉화 선언된 필드
//또는 메소드는 자식클래스에서 접근 불가능

//자식클래스의 생성자로 객체를 생성할 경우 부모클래스의 생성자가 먼저 호출되어 부모클래스의
//객체 생성 후 자식클래스의 객체 생성 - 객체간의 상속관계가 자동으로 성립
