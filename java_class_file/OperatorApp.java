...
//연산자(Operator) : 계산을 목적으로 제공 기호 또는 키워드
// => 피연산자 : 연산자에 의해 계산될 값을 의미
// => 단항연산자(피연산자 : 1개), 이항연산자(피연산자 : 2개), 삼항연산자(피연산자 : 3개)
// => 일반 연산자는 왼쪽에서 오른쪽으로 처리되지만, 단항 연산자와 대입 연산자는 오른쪽에서 왼쪽으로 처리
// ex) 10+20+30       a=b=c
//     ------->      <-----
...
public class OperatorApp {
	public static void main(String[] args) {
		...
		// => () : 우선처리연산자, [] : 배열연산자,  . : 객체 연산자
		System.out.println("10 + 20 * 3 = "+(10+20*3));
		System.out.println("(10 + 20) * 3 = "+((10+20)*3));
		System.out.println("============================================================");
		//단항연산자 : 피연산자의 갯수가 1개인 연산자 
		// => + : 양수화 연산자 - 피연산자에 +1을 곱하는 연산자
		// => - : 음수화 연산자(2의 보수 연산자(양수를 음수로 변환해주고 음수를 양수로 변환해주는 연산자)) - 피연산자에 -1을 곱하는 연산자
		// => ~ : Bit Not 연산자(2의 보수 연산자) - 정수값으로 표현된 Bit값을 반대로 변환하는 연산자
		// => ! : Not 연산자 - false(거짓) 또는 true(참)을 반대로 변환하는 연산자
		// => ++ : 1증가 연산자 - 피연산자가 반드시 변수로 변수값을 1증가 시키는 연산자
		// => -- : 1감소 연산자 - 피연산자가 반드시 변수로 변수값을 1감소 시키는 연산자
		...
		int result1=++a4; //선처리 : ++a4 연산식 실행 후 result1=a4 연산식 실행
		...
		//50(10) - 4Byte : 00000000 00000000 00000000 00000000 00110010
		//50 << 3 -  00000000 00000000 00000000 00000001 10010000 : 400(10)
		//50 >> 3 -  00000000 00000000 00000000 00000000 00000110 : 6(10)
		//-50(10) - 4Byte : 11111111 11111111 11111111 11111111 11001110
		//-50 >> 3 - 11111111 11111111 11111111 11111111 11111001 : -7(10)
		//-50 >>> 3 - 00011111 11111111 11111111 11111111 11111001
		
		//비교 연산자 : 값(객체)을 비교하여 false(거짓) 또는 true(참) 중 하나의 결과를 가져오는 연산자
		...
		// => Bit 논리 연산자 : 정수값을 Bit 단위로 계산하기 위한 연산자 - &(논리곱) , ^(베타적 논리합), !(논리 부정)
		...
		System.out.println("c < 10 || c > 30 ="+(c < 10 || c > 30));
		System.out.println("============================================================");
		//대입 연산자 : 왼쪽 피연산자에 값을 저장하기 위한 연산자 - 무조건 마지막에 실행
		// => 순수 대입 연산자(=) : 값을 변수에 저장 - = 
		// =>복합 대입 연산자 : 변수값을 계산하여 변수에 저장 - *=, /=, %=, +=, -=, <<=, >>=
		int d=10;
